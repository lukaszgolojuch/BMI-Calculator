...
//  Edited and adjusted by Łukasz Gołojuch on 6/14/22.
//
...
struct PieChartView_Previews: PreviewProvider {
    static var previews: some View {
        PieChartView(values: [1300, 500, 300], names: ["Rent", "Transport", "Education"], formatter: {value in String(format: "%.0f kcal", value)})
    }
}
